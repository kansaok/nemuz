...
func main() {
	...
	root.AddCommand(versionCmd(), doctorCmd(), journalCmd(), replayCmd(), runCmd(), providersCmd(), pluginCmd(), skillCmd(), memoryCmd(), serveCmd(), acpCmd(), searchCmd(), usageCmd(), indexCmd(), toolWorkerCmd(), configCmd())
